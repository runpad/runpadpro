...
HRESULT STDMETHODCALLTYPE IRunpadProShell_GetShellPid_Proxy( 
    IRunpadProShell * This,
    /* [out] */ DWORD *lpdwPID);


void __RPC_STUB IRunpadProShell_GetShellPid_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_GetShellMode_Proxy( 
    IRunpadProShell * This,
    /* [out] */ DWORD *lpdwFlags);


void __RPC_STUB IRunpadProShell_GetShellMode_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_IsShellOwnedWindow_Proxy( 
    IRunpadProShell * This,
    /* [in] */ HWND hWnd,
    /* [out] */ BOOL *lpbOwned);


void __RPC_STUB IRunpadProShell_IsShellOwnedWindow_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_GetFolderPath_Proxy( 
    IRunpadProShell * This,
    /* [in] */ RSHELLFOLDER dwFolderType,
    /* [size_is][out] */ LPSTR lpszPath,
    /* [in] */ DWORD cbPathLen);
...
void __RPC_STUB IRunpadProShell_GetFolderPath_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_GetCurrentSheet_Proxy( 
    IRunpadProShell * This,
    /* [size_is][out] */ LPSTR lpszName,
    /* [in] */ DWORD cbNameLen);


void __RPC_STUB IRunpadProShell_GetCurrentSheet_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_EnableSheets_Proxy( 
    IRunpadProShell * This,
    /* [in] */ LPCSTR lpszName,
    /* [in] */ BOOL bEnable);


void __RPC_STUB IRunpadProShell_EnableSheets_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_RegisterClient_Proxy( 
    IRunpadProShell * This,
    /* [in] */ LPCSTR lpszClientName,
    /* [in] */ LPCSTR lpszClientPath,
    /* [in] */ DWORD dwFlags);
...
void __RPC_STUB IRunpadProShell_RegisterClient_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_ShowInfoMessage_Proxy( 
    IRunpadProShell * This,
    /* [in] */ LPCSTR lpszText,
    /* [in] */ DWORD dwFlags);


void __RPC_STUB IRunpadProShell_ShowInfoMessage_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_DoSingleAction_Proxy( 
    IRunpadProShell * This,
    /* [in] */ RSHELLACTION dwAction);


void __RPC_STUB IRunpadProShell_DoSingleAction_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_VipLogin_Proxy( 
    IRunpadProShell * This,
    /* [in] */ LPCSTR lpszLogin,
    /* [in] */ LPCSTR lpszPassword,
    /* [in] */ BOOL bWait);
...
void __RPC_STUB IRunpadProShell_VipLogin_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_VipRegister_Proxy( 
    IRunpadProShell * This,
    /* [in] */ LPCSTR lpszLogin,
    /* [in] */ LPCSTR lpszPassword,
    /* [in] */ BOOL bWait);
...
void __RPC_STUB IRunpadProShell_VipRegister_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IRunpadProShell_VipLogout_Proxy( 
    IRunpadProShell * This,
    /* [in] */ BOOL bWait);


void __RPC_STUB IRunpadProShell_VipLogout_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);

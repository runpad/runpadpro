...
MIDL_DEFINE_GUID(IID, IID_IRunpadProShell,0x83C12BF7,0xFF8F,0x4619,0x85,0xCD,0x9D,0xA7,0x7C,0x8D,0x7D,0x5F);
...
MIDL_DEFINE_GUID(CLSID, CLSID_RunpadProShell,0x3D4B9FF0,0x329A,0x4ed9,0xA3,0x41,0xB0,0x7A,0xE0,0x52,0xB7,0xD6);

...
c_TransportLevel::c_TransportLevel(SOCKET sock_client, sockaddr_in addr_client, size_t i_len_addr, 
								   unsigned int id_client, CRfmSocket *p_rfm_socket) : 
	CRfmServerClient(sock_client, addr_client, i_len_addr, id_client, p_rfm_socket), 
	m_LogicLevel(static_cast<CRfmServerClient*>(this))
{
...
{
	// Остановить текущую операцию на логическом уровне
